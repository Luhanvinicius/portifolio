    ...
    <section id="servicos" className="relative py-32 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6">
          ...
          {services.map((service) => {
            ...
            return (
              <motion.div
                ...
                className="group relative animated-border p-8 hover:bg-secondary/50 transition-all duration-500 card-hover"
              >
                {/* Icon */}
                <div className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${service.gradient} border border-${service.color}/20 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300`}>
                ...
                {/* Arrow */}
                <div className="flex items-center gap-2 text-accent-green opacity-0 group-hover:opacity-100 transition-opacity duration-300">
        ...
        >
          <a
            href="#contato"
            className="inline-flex items-center gap-3 px-8 py-4 border border-accent-green/30 text-accent-green font-semibold rounded-full hover:bg-accent-green/10 transition-all duration-300"
          >
